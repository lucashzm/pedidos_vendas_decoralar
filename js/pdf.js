async function gerarPDF(idPedido){
 ...
 const info=['Cliente ciente do modelo, características e especificações do produto adquirido.','Cliente responsável pela conferência das medidas do ambiente.','Produto deve ser conferido no momento do recebimento.','Divergências ou avarias aparentes devem ser informadas no ato da entrega.'];
